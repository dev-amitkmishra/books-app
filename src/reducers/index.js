...
// const booksReducer = (state = initialState) => {
//     console.log('sdnbfvghdsfsd', state)
//     return state;
// }

// const addBookReducer = (state = [], action) => {
//     console.log('dsnbfhjsd', action);
    
//     if (action.type === 'ADD_BOOK') {
//         return updateObject(state, {
//             payload: initialState.concat(action.payload)
//         })
//     }
//     return null;
// }
